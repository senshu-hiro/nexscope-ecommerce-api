# Chuhaijiang TikTok Creator Related Videos API

Chuhaijiang TikTok Creator Related Videos with public market data.

[All APIs](../../README.md#complete-api-catalog) · [Official documentation](https://www.nexscope.ai/api-docs/chuhaijiang-tiktok-creator-related-videos?view=api&co-from=github-ecommerce-api)
...
```bash
cp payloads/chuhaijiang-tiktok-creator-related-videos.json request.json
# Edit request.json for your inputs.
bash examples/curl/run.sh chuhaijiang-tiktok-creator-related-videos request.json
# Or: node examples/javascript/run.mjs chuhaijiang-tiktok-creator-related-videos request.json
# Or: python3 examples/python/run.py chuhaijiang-tiktok-creator-related-videos request.json
```
...
- [Request definition](../../schemas/chuhaijiang-tiktok-creator-related-videos.request.json) — json-schema
- [Response definition](../../schemas/chuhaijiang-tiktok-creator-related-videos.response.json) — json-schema
- [Editable request sample](../../payloads/chuhaijiang-tiktok-creator-related-videos.json)
- [Response fixture](../../examples/responses/chuhaijiang-tiktok-creator-related-videos.json)

Some source definitions use field descriptors rather than JSON Schema; these are preserved and labeled rather than presented as strict validation schemas.

## MCP

Tool name: `nexscope_chuhaijiang_tiktok_creator_related_videos`. See [MCP integration](../calling-apis.md#mcp).
