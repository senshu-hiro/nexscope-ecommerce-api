...
Generate ecommerce videos with the seedance-2-0-fast model.

[All APIs](../../README.md#complete-api-catalog) · [Official documentation](https://www.nexscope.ai/api-docs/seedance-2-0-fast-video-generation?view=api&co-from=github-ecommerce-api)

Category: Video Generation Models · Creative API

Generate a faster Seedance 2.0 video using a primary image, up to 9 reference images, or a reference video. The model is fixed by this API, so videoType must not be supplied in the request.

## Endpoint

`POST https://api.nexscope.ai/api/skill-api/v1/skills/seedance-2-0-fast-video-generation/run`
...
Task result: `GET https://api.nexscope.ai/api/skill-api/v1/skills/seedance-2-0-fast-video-generation/tasks/{taskId}`
...
```bash
cp payloads/seedance-2-0-fast-video-generation.json request.json
# Edit request.json for your inputs.
bash examples/curl/run.sh seedance-2-0-fast-video-generation request.json
# Or: node examples/javascript/run.mjs seedance-2-0-fast-video-generation request.json
# Or: python3 examples/python/run.py seedance-2-0-fast-video-generation request.json
```
...
- [Request definition](../../schemas/seedance-2-0-fast-video-generation.request.json) — field-descriptors
- [Response definition](../../schemas/seedance-2-0-fast-video-generation.response.json) — field-descriptors
- [Editable request sample](../../payloads/seedance-2-0-fast-video-generation.json)
- [Response fixture](../../examples/responses/seedance-2-0-fast-video-generation.json)

Some source definitions use field descriptors rather than JSON Schema; these are preserved and labeled rather than presented as strict validation schemas.

## MCP

Tool name: `nexscope_seedance_2_0_fast_video_generation`. See [MCP integration](../calling-apis.md#mcp).
