...
Generate ecommerce videos with the kling-v3-omni model.

[All APIs](../../README.md#complete-api-catalog) · [Official documentation](https://www.nexscope.ai/api-docs/kling-3-omni-video-generation?view=api&co-from=github-ecommerce-api)
...
`POST https://api.nexscope.ai/api/skill-api/v1/skills/kling-3-omni-video-generation/run`
...
Task result: `GET https://api.nexscope.ai/api/skill-api/v1/skills/kling-3-omni-video-generation/tasks/{taskId}`
...
| `imageList` | array | No | Public reference image URLs. Provide 1 to 7 images. | {"maxItems": 7, "minItems": 1} |
| `aspectRatio` | string | No | Target video aspect ratio supported by this model. Supported values: 1:1, 9:16, 16:9. | {"allowedValues": ["1:1", "9:16", "16:9"], "requiredWhenPresent": ["imageList"]} |
...
```bash
cp payloads/kling-3-omni-video-generation.json request.json
# Edit request.json for your inputs.
bash examples/curl/run.sh kling-3-omni-video-generation request.json
# Or: node examples/javascript/run.mjs kling-3-omni-video-generation request.json
# Or: python3 examples/python/run.py kling-3-omni-video-generation request.json
```
...
- [Request definition](../../schemas/kling-3-omni-video-generation.request.json) — field-descriptors
- [Response definition](../../schemas/kling-3-omni-video-generation.response.json) — field-descriptors
- [Editable request sample](../../payloads/kling-3-omni-video-generation.json)
- [Response fixture](../../examples/responses/kling-3-omni-video-generation.json)

Some source definitions use field descriptors rather than JSON Schema; these are preserved and labeled rather than presented as strict validation schemas.

## MCP

Tool name: `nexscope_kling_3_omni_video_generation`. See [MCP integration](../calling-apis.md#mcp).
